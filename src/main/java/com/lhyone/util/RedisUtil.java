...
public class RedisUtil {
	...
	private static JedisPool initializePool() {
		if (pool == null) {
			...
			// timeOut =
			// Integer.valueOf(prop.getProperty("redisServer.poolTimeout").trim());
			String pw = null;
	...
	public static void main(String[] args) throws Exception {
		...
		// RedisUtil.hmset(NnConstans.NN_USER_THREAD_LOCK_CACHE_PRE,map);

		// String a= RedisUtil.hget(NnConstans.NN_USER_THREAD_LOCK_CACHE_PRE,
		// "1");
		// System.out.println(a);

		// RedisUtil.hset("room:"+"400800", "name", value)
		// Set<String> set = RedisUtil.smembers(NnConstans.NN_ROOM_USER_INFO_PRE
		// + "100000");
		boolean falg = RedisUtil.sismember(NnConstans.NN_ROOM_ALL_MATCH_USER_PRE + "100000", "1");
	}
}
